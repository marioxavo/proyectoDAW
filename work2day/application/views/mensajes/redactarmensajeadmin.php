    ...
    <div class="container">
        ...
        <div class="row">
            <div class="panel-mensajes col-md-2 col-sm-3 col-xs-4 col-lg-2">
                    ...
                    <a style="margin-bottom: 20px;" id="redactarBtn" class="btn btn-primary" href="<?php echo $this->config->item('app_url') ?>index.php/mensajeria/" role="button">Bandeja de entrada</a>
            ...
            <div id="divMensajes" class="panel panel-primary tabla-mensajes ">
                ...
                <div class="panel-body">
                    ...
                    <?php } ?>
                    <form method="POST" action="<?= $this->config->item('app_url') ?>index.php/mensajeria/enviarMensajeAdmin">
                        ...
                        <div class="input-group">
                            ...
                            <input name="receptor" readonly type="text" class="form-control" aria-describedby="sizing-addon1" value="Work2Day">
