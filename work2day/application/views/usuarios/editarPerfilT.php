                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="<?php echo $this->config->item('app_url').'index.php/usuario/editarPerfilT';?>">Editar Perfil</a></li>
...
================================================== -->
        ...
        function mostrarDatosPerfil(datos){
            ...
            $('#perfil').fadeOut(400,function(){
                ...
                $('#perfil').append('<div class="campo" id="habilidades">'+datos['habilidades']+'</div>');
                $('#perfil').append('<div class="campo" id="estudios">'+datos['estudios']+'</div>');
                $('#perfil').append('<div class="campo" id="experiencia">'+datos['experiencia']+'</div>');
        ...
        function editarPerfil(){
            ...
            var habilidades=document.getElementById('habilidades').innerHTML;
            var estudios=document.getElementById('estudios').innerHTML;
            var experiencia=document.getElementById('experiencia').innerHTML;
            $('#perfil').fadeOut(400,function(){
                $('#perfil').html('');
                $('#perfil').fadeIn(400);
